...
<%
	List<Medicine> list = MedicineDao.getAllRecords();
...
<div class="row" style="height: 200px">
	<img src="images/p4.jpg" style="height: 200px; object-fit: cover"
		class="card-img-top" />
</div>
<br />
...
<div class="container-fluid" >
	<div class="row justify-content-center" >
		<div class="col-9">
			<div class="container">
				<h3 class="text-center">List of Medicine Order</h3>
				<hr>
				<div class="container text-left">
					<a href="addMedicine.jsp" class="btn btn-success">Add New
						Medicine Order</a>
				</div>
				<br>
				<table class="table table-bordered">
					...
					<tbody>
						...
						<c:forEach items="${list}" var="u">
							...
							<tr>
								<td>${u.getId()}</td>
								<td>${u.getMedicinename()}</td>
								<td>${u.getDrugType()}</td>
								<td>${u.getCompany()}</td>
								<td>${u.getPrice()}</td>
								<td>${u.getQuantity()}</td>
								<td><a href="editMedicine.jsp?id=${u.getId()}"
									class="btn btn-primary mr-3">Edit</a> <a
									href="deleteMedicine.jsp?id=${u.getId()}" class="btn btn-danger">Delete</a></td>
							</tr>
						</c:forEach>
						<!-- } -->
					</tbody>
