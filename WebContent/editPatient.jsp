...
<body>
	...
	<%
		...
		Pharmacy u = PharmacyDao.getRecordById(Integer.parseInt(id));
	%>
						...
						<form action="edituser.jsp" method="post">
							...
							<fieldset class="form-group">
								<label>Patient Name</label> <input type="text"
									value="<%=u.getPatientname()%>" class="form-control"
									name="patientname" required="required">
							</fieldset>

							<fieldset class="form-group">
								<label>Disease</label> <input type="text"
									value="<%=u.getDisease()%>" class="form-control" name="disease"
									required="required">
							</fieldset>
							...
							<fieldset class="form-group">
								<label>Date</label> <input type="text" value="<%=u.getDate()%>"
