...
<title>New Medicine Order</title>
	...
	<div class="container" style="height: 510px">
		<div class=" row justify-content-left">
			<div class="col-5">
				<div class="card">
					<div class="card-body">
						<form action="adduser1.jsp" method="post">
							<caption>
							...
							<fieldset class="form-group">
								<label>Medicine Name</label> <select class="form-select"
									aria-label="Default select example" name="medicinename">
							...
							<fieldset class="form-group">
								<label>Drug Type</label> <select class="form-select"
									aria-label="Default select example" name="drugType">
							...
							<div>
									...
									<input class="btn btn-secondary"  id="cancel" name="cancel" type="button" value="Cancel">
								</div>
						</form>
					</div>
				</div>
			...
			<br /><br />
				<c:if test="${param.q == 1 }">
					<div class="alert alert-success">Medicine order
						Successfully!!</div>
					<p>May good health envelop you, spurring a quick recovery.</p>
					<div>
						<a class="btn btn-success" href="viewMedicine.jsp">View Medicine orders</a>
					</div>
				</c:if>

				<c:if test="${param.q == 0 }">
					<div class="alert alert-danger">
						Patient not Registered Successfully!!!
					</div>
				</c:if>
			</div>
