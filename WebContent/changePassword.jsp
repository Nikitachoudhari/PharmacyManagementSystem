...
<div class="row" style="background-color: #cccccc;">
	<div class="container" style="height: 650px;">
		<div class="col-6 text-light d-flex  justify-content-left ">
			<div class="login-form">
				<form action="changeit.jsp" method="post" class=""
					style="width: 154%">
					...
					<c:if test="${param.q == 0 }">
						<div class="alert alert-danger">Password not changed
							successfully !!!</div>
					</c:if>
					...
					<div class="form-group mt-1">
						<input name="password1" class="form-control form-control-lg"
					...
					<div class=" form-group mt-1">
						<input class="btn btn-secondary btn-block" type="button"
							value="Cancel">
					</div>
